...
export function ProfilePanel({
  ...
  // FIX: Sync userApiKey whenever the selected provider changes.
  // Without this, after saving a key the panel stayed on the saved provider's key
  // and clicking another provider button had no visible effect.
  useEffect(() => {
